...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>RRM Inventory by RRM Gorup | Reset Password</title>
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <form action="javascript:void(0);" method="post" name="formResetPassword" class="reset-pass-form" enctype="multipart/form-data" data-parsley-validate>
                                    <div class="alert alert-success reset-pass-success d-none fade show">
                                        <h4 class="mt-0">Success</h4>
                                        <p class="mb-0">All the required fields are filled!</p>
                                    </div>

                                    <div class="alert alert-danger reset-pass-danger d-none fade show">
                                        <h4 class="mt-0">Error</h4>
                                        <p class="mb-0">Please fill all the required fields!</p>
                                    </div>

                                    <input type="hidden" value="<?= isset($_REQUEST['uid']) ? $_REQUEST['uid'] : '' ?>" name="uid">
                        			<input type="hidden" value="<?= isset($_REQUEST['token']) ? $_REQUEST['token'] : '' ?>" name="token">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="password" name="confirm_password" id="confirm_password" placeholder="Enter your password again" required>
                                    </div>
        ...
        <!-- Validation init js-->
        <script src="assets/js/pages/reset-pass-form-validation.init.js"></script>
