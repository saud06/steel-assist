...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(data){
            if(data.Type == 'success'){
                tot_received_qty = parseFloat(data.Reply[0].tot_received_qty).toFixed(3);
                tot_issued_qty = parseFloat(data.Reply[0].tot_issued_qty).toFixed(3);
                tot_received_val = parseFloat(data.Reply[0].tot_received_val).toFixed(2);
                tot_issued_val = parseFloat(data.Reply[0].tot_issued_val).toFixed(2);

                tot_received_qty2 = parseFloat(data.Reply[0].tot_received_qty2).toFixed(3);
                tot_issued_qty2 = parseFloat(data.Reply[0].tot_issued_qty2).toFixed(3);
                tot_received_val2 = parseFloat(data.Reply[0].tot_received_val2).toFixed(2);
                tot_issued_val2 = parseFloat(data.Reply[0].tot_issued_val2).toFixed(2);

                tot_received_qty3 = parseFloat(data.Reply[0].tot_received_qty3).toFixed(3);
                tot_issued_qty3 = parseFloat(data.Reply[0].tot_issued_qty3).toFixed(3);
                tot_received_val3 = parseFloat(data.Reply[0].tot_received_val3).toFixed(2);
                tot_issued_val3 = parseFloat(data.Reply[0].tot_issued_val3).toFixed(2);
            }
    ...
    options = {
        ...
        series: [{
            name: "Received",
            data: [tot_received_qty3, tot_received_qty2, tot_received_qty]
        }, {
            name: "Issued",
            data: [tot_issued_qty3, tot_issued_qty2, tot_issued_qty]
        }],
        grid: {
            row: {
        ...
        xaxis: {
            categories: [month_name[d.getMonth()-2] + ', ' + d.getFullYear(), month_name[d.getMonth()-1] + ', ' + d.getFullYear(), month_name[d.getMonth()] + ', ' + d.getFullYear()],
            title: {
                text: "Month"
            }
        },
    ...
    options = {
        ...
        series: [{
            name: "Received",
            data: [tot_received_val3, tot_received_val2, tot_received_val]
        }, {
            name: "Issued",
            data: [tot_issued_val3, tot_issued_val2, tot_issued_val]
        }],
        grid: {
            row: {
                colors: ["transparent", "transparent"],
    ...
    (chart = new ApexCharts(document.querySelector("#apex-line-11"), options)).render();
});
...
$(document).ready(function(){
    ...
    options = {
        ...
        colors: ["#f0643b", "#56c2d6", "#f8cc6b", "#23b397", "#2462be"],
        series: [{
            name: "CHEMICAL",
            data: [summary_data['bcp'].chemical, summary_data['con'].chemical, summary_data['hrm'].chemical, summary_data['hrm2'].chemical]
        }, {
            name: "MECHANICAL",
            data: [summary_data['bcp'].mechanical, summary_data['con'].mechanical, summary_data['hrm'].mechanical, summary_data['hrm2'].mechanical]
        }, {
            name: "ELECTRICAL",
            data: [summary_data['bcp'].electrical, summary_data['con'].electrical, summary_data['hrm'].electrical, summary_data['hrm2'].electrical]
        }, {
            name: "GENERAL",
            data: [summary_data['bcp'].general, summary_data['con'].general, summary_data['hrm'].general, summary_data['hrm2'].general]
        }, {
            name: "MACHINERY",
            data: [summary_data['bcp'].machinery, summary_data['con'].machinery, summary_data['hrm'].machinery, summary_data['hrm2'].machinery]
        }],
        xaxis: {
            categories: ["BCP", "CONCAST", "HRM", "HRM Unit-2"]
        },
        legend: {
            offsetY: -10
        },
...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(data){
            if(data.Type == 'success'){
                tot_pending = data.Reply[0].tot_pending;
                tot_approved = data.Reply[0].tot_approved;
                tot_rejected = data.Reply[0].tot_rejected;

                tot_pending2 = data.Reply[0].tot_pending2;
                tot_approved2 = data.Reply[0].tot_approved2;
                tot_rejected2 = data.Reply[0].tot_rejected2;

                tot_pending3 = data.Reply[0].tot_pending3;
                tot_approved3 = data.Reply[0].tot_approved3;
                tot_rejected3 = data.Reply[0].tot_rejected3;
            }
    ...
    options = {
        ...
        series: [tot_pending, tot_approved, tot_rejected],
        labels: ["PENDING", "APPROVED", "REJECTED"],
        colors: ["#f8cc6b", "#23b397", "#f0643b"],
        legend: {
            show: !0,
            position: "bottom",
    ...
    options = {
        ...
        series: [tot_pending2, tot_approved2, tot_rejected2],
        labels: ["PENDING", "APPROVED", "REJECTED"],
        colors: ["#f8cc6b", "#23b397", "#f0643b"],
        legend: {
            show: !0,
    ...
    (chart = new ApexCharts(document.querySelector("#apex-pie-11"), options)).render();
    ...
    options = {
        ...
        series: [tot_pending3, tot_approved3, tot_rejected3],
        labels: ["PENDING", "APPROVED", "REJECTED"],
        colors: ["#f8cc6b", "#23b397", "#f0643b"],
        legend: {
            show: !0,
    ...
    (chart = new ApexCharts(document.querySelector("#apex-pie-111"), options)).render();
});
